...
plt.title(f'MCULoRA(ours)', fontsize=50, fontname='sans-serif')  # Further increase title font size
...
plt.savefig(f'test_accuracy_conditions_smoothed_folder{folder}sjs.png')  # Save the plot as an image
plt.show()
